...
try {
		Debug.PushSubsStack("GetFileUri (fileprovider) ","fileprovider",6,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("Initialize (fileprovider) ","fileprovider",6,__ref.getField(false, "ba"),__ref,8);
...
fileprovider.__c.runVoidMethod ("LogImpl","27143434",(RemoteObject.concat(RemoteObject.createImmutable("Using FileProvider? "),fileprovider.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_usefileprovider" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("SetFileUriAsIntentData (fileprovider) ","fileprovider",6,__ref.getField(false, "ba"),__ref,40);
...
Debug.ShouldStop(512);
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setData")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.runClassMethod (anetocalcV4.cerolab.fileprovider.class, "_getfileuri" /*RemoteObject*/ ,(Object)(_filename))})));
